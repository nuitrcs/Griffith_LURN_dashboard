...
bph <- clean_real_data(read.csv("../data/EH22021EnhancedClini-LURNSI29Report_DATA_2023-09-08_1340.csv"), params$study_arm, params$patient_week)
...
bar_chart <- create_current_week_summary_bar_chart(bph$arm_dat_week, show_median = params$show_median, show_density = params$show_density)
line_plot <- create_time_series_line_plot(bph$arm_dat, show_median = params$show_median, show_density = params$show_density)
